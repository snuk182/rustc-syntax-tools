...
use print::pprust;
use ptr::P;
use syntex_data_structures::indexed_vec;
use syntex_data_structures::indexed_vec::Idx;
...
pub use syntex_target::abi::FloatTy;
...
impl IntTy {
    ...
    pub fn val_to_string(&self, val: i128) -> String {
        // cast to a u64 so we can correctly print INT128_MIN. All integral types
