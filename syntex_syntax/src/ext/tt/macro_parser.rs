...
use ast::Ident;
use syntex_pos::{self, BytePos, Span};
...
pub enum ParseResult<T> {
    ...
    Failure(syntex_pos::Span, Token),
    /// Fatal error (malformed macro?). Abort compilation.
    Error(syntex_pos::Span, String),
}
...
#[derive(Debug, Clone)]
pub enum NamedMatch {
    MatchedSeq(Rc<Vec<NamedMatch>>, syntex_pos::Span),
