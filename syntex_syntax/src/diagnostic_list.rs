...
register_diagnostics! {
    ...
    E0540, // multiple syntex_deprecated attributes
    E0542, // missing 'since'
    ...
    E0549, // syntex_deprecated attribute must be paired with either stable or unstable attribute
    E0550, // multiple deprecated attributes
    E0551, // incorrect meta item
    E0553, // multiple syntex_const_unstable attributes
    E0555, // malformed feature attribute, expected #![feature(...)]
    E0556, // malformed feature, expected just one word
    E0584, // file for module `..` found at both .. and ..
    E0629, // missing 'feature' (syntex_const_unstable)
    E0630, // syntex_const_unstable attribute must be paired with stable/unstable attribute
