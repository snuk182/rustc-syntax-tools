...
use syntex_data_structures::sync::{Lrc, Lock};
use ast::{self, CrateConfig, NodeId};
use early_buffered_lints::{BufferedEarlyLint, BufferedEarlyLintId};
use codemap::{CodeMap, FilePathMapping};
use syntex_pos::{Span, FileMap, FileName, MultiSpan};
...
mod tests {
    use super::*;
    use syntex_pos::{Span, BytePos, Pos, NO_EXPANSION};
