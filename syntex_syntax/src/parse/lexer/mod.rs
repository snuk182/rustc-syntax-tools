...
use ast::{self, Ident};
use syntex_pos::{self, BytePos, CharPos, Pos, Span, NO_EXPANSION};
...
pub struct StringReader<'a> {
    ...
    pub ch: Option<char>,
    pub filemap: Lrc<syntex_pos::FileMap>,
...
impl<'a> StringReader<'a> {
    ...
    fn new_raw(sess: &'a ParseSess, filemap: Lrc<syntex_pos::FileMap>,
    ...
    fn new_raw_internal(sess: &'a ParseSess, filemap: Lrc<syntex_pos::FileMap>,
                        override_span: Option<Span>) -> Self {
        ...
        StringReader {
            ...
            peek_tok: token::Eof,
            peek_span: syntex_pos::DUMMY_SP,
            peek_span_src_raw: syntex_pos::DUMMY_SP,
            src,
            fatal_errs: Vec::new(),
            token: token::Eof,
            span: syntex_pos::DUMMY_SP,
            span_src_raw: syntex_pos::DUMMY_SP,
            open_braces: Vec::new(),
            override_span,
        }
    }

    pub fn new(sess: &'a ParseSess, filemap: Lrc<syntex_pos::FileMap>, override_span: Option<Span>)
               -> Self {
...
mod tests {
    ...
    use symbol::Symbol;
    use syntex_pos::{BytePos, Span, NO_EXPANSION};
    use codemap::CodeMap;
    use errors;
