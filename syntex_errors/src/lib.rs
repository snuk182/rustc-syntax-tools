...
use syntex_data_structures::sync::{self, Lrc, Lock, LockCell};
use syntex_data_structures::fx::FxHashSet;
...
use syntex_pos::{BytePos, Loc, FileLinesResult, FileMap, FileName, MultiSpan, Span, NO_EXPANSION};
...
impl CodeSuggestion {
    ...
    pub fn splice_lines(&self, cm: &CodeMapperDyn)
        ...
        use syntex_pos::{CharPos, Loc, Pos};
